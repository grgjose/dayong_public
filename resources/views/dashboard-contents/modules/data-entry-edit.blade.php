        ...
        <fieldset class="border p-3 mb-2 rounded" style="--bs-border-opacity: .5;">
            ...
            <div class="row">
                ...
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="or_number" name="or_number" value="{{ $entries->or_number; }}">
                </div>
                <div class="form-group col">
                    <label for="amount">Amount:</label>
                    <input type="number" class="form-control" id="amount" name="amount" value="{{ $entries->amount; }}">
                </div>
            </div> <br>
            <div class="row">
                <div class="form-group col">
                    <label for="times">How many Payments:</label>
                    <input type="number" class="form-control" id="times" name="number_of_payment" value="{{ $entries->number_of_payment; }}">
                </div>
                <div class="form-group col">
                    <label for="month_from">From (Month):</label>
                    <input type="month" class="form-control" id="times" name="month_from" value="{{ $entries->month_from; }}">
                </div>
                <div class="form-group col">
                    <label for="month_to">To (Month):</label>
                    <input type="month" class="form-control" id="times" name="month_to" value="{{ $entries->month_to; }}">
                </div>
            </div> <br>
            <div class="row">
                <div class="form-group col">
                ...
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="remarks" name="remarks" value="{{ $entries->remarks; }}">
                </div>
            </div> <br>
        </fieldset>
