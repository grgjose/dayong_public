    ...
    <div class="container">
        ...
        <div class="details">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        @foreach($branches as $branch)
                            @if($branch->id == $members_program->branch_id)
                                {{ $branch->branch; }}
                            @endif
                        @endforeach
                    </td>
                ...
                <tr>
                    <th>Members Name</th>
                    <td>{{ strtoupper($member->fname.' '.$member->lname); }}</td>
                </tr>
                <tr>
                    <th>Cashiers Name</th>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $entry->amount; }}</td>
                        <td>{{ $entry->month_from.' '.$entry->month_to; }}</td>
                        <td>{{ $entry->remarks; }}</td>
                        @php
                            $total_nop = $total_nop + (int)$entry->number_of_payment;
                            $total_amount = $total_amount + (int)$entry->amount;
                        @endphp
                    </tr>
                    @endforeach
                    <tr>
        ...
        <div class="footer">
            <div class="signature col-6">
                ...
                <div class="signature-field col-6">
                  <p>_______________________________</p>
                  <p> Encoder </p>
                </div>
            </div>
